...
export const ImportWalletPrivateKey = () => {
  ...
  const OnImportPress = async () => {
    ...
    try {
      ...
      setTimeout(async () => {
        // TODO: there is not a validatePrivateKeyCreds method in akroma-react-native
        ...
        {loading ? (
          ...
          <View style={GlobalStyles.container}>
            <View>
              ...
              <Input style={GlobalStyles.input} onChangeText={setPk} value={pk} placeholder="Wallet name, min 5 chars" disabled={loading} />
