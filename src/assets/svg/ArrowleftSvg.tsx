...
function ArrowleftSvg(props: Props | any) {
  return (
    <Svg width={props.size ? props.size : 18} height={props.size ? props.size : 18} viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <Path
        ...
        fill={props.color ? props.color : '#1C1C1E'}
      />
    </Svg>
  );
}
